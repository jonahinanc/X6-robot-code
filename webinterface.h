...
void handle_root(){
  ...
  //Webpage Styling 
  String html = "<!DOCTYPE html> <html style=\"background-color:CadetBlue;\"> <head><meta name=\"viewport\" content=\"width=device-width, minimumscale=1.0, maximum-scale=1.0, initial-scale=1\" /><style> body {text-align: left; max-width: 800px; margin: 10px auto;} ";
  ...
  //html body 
  html += "<body> <h1 style=\"text-align: left;\">Climbing Robot X5 Mini</h1> <p>&nbsp;</p>"; 

  //generating the DOWNLOAD button
  //CHANGE NAME OF csv output file HERE!!!
  html += "<body><a href=\"/X5_mini.csv\"><button style=\"display: block; width: 100%;\">DOWNLOAD</button></a><br/></body>";
  ...
  html += speed_val_foot;
  html += "'><BR>";
  html += "Shoulder angle:<input type='text' name='shoulderangle_input' value='"; 
  html += shoulder_angle;
  html += "'><BR>";
  ...
  html += rom_feet;
  html += "'><BR>";
  html += "Shoulder range of motion:<input type='text' name='range_input3' value='";
  html += rom_shoulders;
  html += "'><BR>";
  ...
  if (server.args() > 0 ) { // Arguments were received
    for ( uint8_t i = 0; i < server.args(); i++ ) {
      ...
      if (server.argName(i) == "shoulderangle_input") {

        shoulder_angle = server.arg(i).toInt();
      }
      ...
      if (server.argName(i) == "range_input3") {

        rom_shoulders = server.arg(i).toInt();
      }
    ...
    h_lfsa = hh_lfsa - shoulder_angle; // MINUS
    h_rfsa = hh_rfsa + shoulder_angle; // MINUS
    h_rff = hh_rff + foot_center;
    h_rhf = hh_rhf + foot_center;
    h_rhs = (hh_rhs + hind_leg_center); //
    h_lhs = (hh_lhs - hind_leg_center); //
    h_rhsa = hh_rhsa - shoulder_angle; // MINUS
    h_lhsa = hh_lhsa + shoulder_angle; // MINUS
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[0];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[0]; // ygyro
  txt += ", ";
  txt += peak_acc_zaxis[0]; // zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[1];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[1];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[1];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[2];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[2];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[2];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[3];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[3];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[3];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[4];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[4];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[4];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[5];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[5];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[5];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[6];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[6];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[6];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[7];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[7];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[7];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[8];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[8];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[8];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[9];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[9];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[9];//zgyro
  txt += ", ";
...
//fixed vals 
  ...
  txt += ", ";
  txt += peak_acc_xaxis[10];//xgyro
  txt += ", ";
  txt += peak_acc_yaxis[10];//ygyro
  txt += ", ";
  txt += peak_acc_zaxis[10];//zgyro
  txt += ", ";
